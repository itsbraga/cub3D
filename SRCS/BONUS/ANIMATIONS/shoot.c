...
/*   Updated: 2025/04/11 03:58:29 by art3mis          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	shoot(t_game *game)
{
	...
	if (game->data->weapon_count == 0)
		return ;
	// curr_weapon = game->data->weapons[game->data->curr_weapon_idx];
	curr_weapon = game->data->weapons[0];
