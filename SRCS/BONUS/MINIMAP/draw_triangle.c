...
*/
static void	__draw_first_part(t_minimap *mmap, t_triangle *tr)
{
	int	start_y;
	int	end_y;
	...
	if (start_y < end_y)
	{
		...
		draw_hline(mmap, tr, start_y, end_y);
	}
}
...
*/
static void	__draw_second_part(t_minimap *mmap, t_triangle *tr)
{
	int	start_y;
	int	end_y;
...
void	fill_triangle(t_minimap *mmap, t_point a, t_point b, t_point c)
{
	...
	__draw_first_part(mmap, &tr);
	__draw_second_part(mmap, &tr);
}
