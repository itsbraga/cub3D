...
/*   Updated: 2025/03/10 00:52:31 by art3mis          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_game(t_game *game)
{
	...
	game->player->pos.x = 800; // a remplacer
	game->player->pos.y = 700; // a remplacer
	game->player->dir = N;
}
...
void	init_raycasting(t_raycasting *ray, t_game *game)
{
	...
	ray->fov = 45;
	ray->player_rad = degree_to_radian(game->player->dir);
	ray->h_offset.x = 0;
	ray->h_offset.y = 0;
	ray->v_offset.x = 0;
	ray->v_offset.y = 0;
