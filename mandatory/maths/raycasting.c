...
/*   Updated: 2025/03/10 00:54:35 by art3mis          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_point *closest_inter)
{
	...
	delta_xh = r->h_ray_inter.x - game->player->pos.x;
	delta_yh = r->h_ray_inter.y - game->player->pos.y;
	delta_xv = r->v_ray_inter.x - game->player->pos.x;
	delta_yv = r->v_ray_inter.y - game->player->pos.y;
