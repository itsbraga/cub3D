...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/24 17:03:35 by annabrag          #+#    #+#             */
/*   Updated: 2025/02/26 21:11:56 by art3mis          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_player(t_mlx *mlx, t_data *data, t_point player)
{
	...
	draw_line_2d(mlx, a, b, YELLOW_PIX);
	draw_line_2d(mlx, b, c, YELLOW_PIX);
	draw_line_2d(mlx, c, a, YELLOW_PIX);
	__fill_triangle(mlx, a, b, c, YELLOW_PIX);
}
