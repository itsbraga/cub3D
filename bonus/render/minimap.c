...
/*   Updated: 2025/02/28 00:47:46 by art3mis          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3D_bonus.h"

static void	__draw_tile(t_vector tile)
{
	t_vector	pixel;
	t_vector	end;
...
void	draw_minimap(t_data *data, t_map *minimap)
{
	...
	tile.y = 0;
	data->minimap_pos.x = WIN_WIDTH - data->minimap.width - 30;
	data->minimap_pos.y = WIN_HEIGHT - data->minimap.height - 30;
